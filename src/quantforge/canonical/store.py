...
:class:`~quantforge.xbrl.store.RawXbrlStore`. This store references the instance
...
from quantforge.canonical.canonicalize import CanonicalizeResult
...
#: (:data:`~quantforge.canonical.version.CANONICAL_FACT_VERSION`): this governs
