...
:class:`~quantforge.xbrl.parser.ParsedInstance` (or its constituent raw records)
it produces the deterministic set of canonical
:class:`~quantforge.canonical.model.Fact` records, retaining complete lineage
...
:class:`~quantforge.canonical.errors.CanonicalContradictionError` (§13 case 8).
...
from quantforge.canonical.errors import CanonicalContradictionError, CanonicalError
...
from quantforge.canonical.numeric import NumericValue, canonicalize_numeric
from quantforge.canonical.period import CanonicalPeriod, canonicalize_period
from quantforge.canonical.units import CanonicalUnit, canonicalize_unit
from quantforge.canonical.version import CanonicalFactVersion
from quantforge.xbrl.contexts import RawContext
from quantforge.xbrl.model import RawDocument, RawFact
from quantforge.xbrl.parser import ParsedInstance
...
class Canonicalizer:
    ...
    def canonicalize(self, parsed: ParsedInstance) -> CanonicalizeResult:
        ...
        :class:`~quantforge.canonical.errors.CanonicalError` (or its
    ...
    def canonicalize_records(
        ...
        *,
        ...
        :meth:`~quantforge.xbrl.store.RawXbrlStore.read_instance` returns without
