...
§15.10) into the raw records defined in :mod:`quantforge.xbrl.model`.
...
from quantforge.xbrl.dimensions import RawDimension
...
from quantforge.xbrl.namespaces import XBRLDI_NS, XBRLI_NS, XSI_NS
