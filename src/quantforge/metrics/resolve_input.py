...
The load-bearing subtlety (§7.0): a :class:`~quantforge.canonical.model.Fact`'s
...
from quantforge.metrics.formula import InputBinding
...
from quantforge.metrics.units import ResolvedUnit, unit_of_fact
from quantforge.xbrl.contexts import PeriodType
from quantforge.xbrl.dimensions import dimensions_hash
...
class MetricBoundary:
    ...
    :class:`~quantforge.availability.resolve.PitValue` /
    :class:`~quantforge.availability.resolve.RevisedValue`.
    """
