...
ENV_USER_AGENT: Final = "OPENFINANCE_SEC_USER_AGENT"
ENV_STORAGE_DIR: Final = "OPENFINANCE_SEC_STORAGE_DIR"
ENV_MAX_REQUESTS_PER_SECOND: Final = "OPENFINANCE_SEC_MAX_RPS"
ENV_TIMEOUT_SECONDS: Final = "OPENFINANCE_SEC_TIMEOUT"
ENV_MAX_RETRIES: Final = "OPENFINANCE_SEC_MAX_RETRIES"
    ...
    def __post_init__(self) -> None:
        if not self.user_agent or not self.user_agent.strip():
            raise ConfigError(
                ...
                "(e.g. 'OpenFinance research@example.com')"
            )
