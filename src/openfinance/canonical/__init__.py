"""OpenFinance canonical financial observation layer (Phase 4).

Transforms the immutable, loss-preserving :class:`~openfinance.xbrl.model.RawFact`
records produced by Phase 3 into deterministic, structured canonical
:class:`~openfinance.canonical.model.Fact` records — one canonical observation per
...
from openfinance.canonical.errors import (
    CanonicalContradictionError,
    CanonicalError,
)
from openfinance.canonical.ingest import (
