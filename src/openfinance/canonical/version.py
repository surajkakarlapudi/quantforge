...
:class:`~openfinance.xbrl.model.RawFact` records into canonical
:class:`~openfinance.canonical.model.Fact` records: concept/taxonomy
...
versions (:mod:`openfinance.registry.version`, :mod:`openfinance.xbrl.version`).
