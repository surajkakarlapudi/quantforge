...
This module maps a Phase 3 :class:`~openfinance.xbrl.units.RawUnit` (a structural
...
* **Separate raw unit from canonical unit.** The raw structure (numerator /
  ...
  on the Fact via :class:`~openfinance.canonical.model.Fact` fields — this module
...
(:mod:`openfinance.canonical.numeric`).
"""
...
from openfinance.xbrl.qnames import split_clark
