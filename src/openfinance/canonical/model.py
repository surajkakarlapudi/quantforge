...
from one or more :class:`~openfinance.xbrl.model.RawFact` records by the Phase 4
...
class CanonicalDimension:
    ...
    Mirrors the Phase 3 :class:`~openfinance.xbrl.dimensions.RawDimension` shape so
...
class Fact:
    ...
    def from_dict(cls, raw: dict[str, object]) -> Fact:
        from openfinance.canonical.concept import Concept as _Concept
