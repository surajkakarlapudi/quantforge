"""OpenFinance Filing Registry (Phase 2).

Transforms the immutable SEC acquisition artifacts produced by Phase 1
(:mod:`openfinance.sec`) into a structured, deterministic registry of filings
...
from openfinance.registry.errors import (
...
from openfinance.registry.store import REGISTRY_FORMAT_VERSION, RegistryStore
from openfinance.registry.submissions import SubmissionsArtifact
from openfinance.registry.version import (
